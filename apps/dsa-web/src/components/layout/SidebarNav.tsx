...
import { BarChart3, BriefcaseBusiness, Gem, Home, LogOut, MessageSquareQuote, Newspaper, Scan, Settings2, Star, TrendingUp } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'scanner', label: '扫股', to: '/scanner', icon: Scan },

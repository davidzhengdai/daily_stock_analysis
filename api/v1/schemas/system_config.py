...
class SystemConfigFieldSchema(BaseModel):
    ...
    category: Literal["base", "data_source", "ai_model", "notification", "system", "agent", "sentinel", "discovery", "backtest", "uncategorized"]
    data_type: Literal["string", "integer", "number", "float", "boolean", "array", "json", "time"]

...
3. 具体股票线索（如有）：值得立即深度分析的股票代码与理由，含置信度（≥0.7 才填入）
   - 只允许 A 股、港股、美股代码：如 600519、300750、688981、HK00700、00700.HK、AAPL、NVDA、BRK.B
   - 禁止输出非支持市场代码：如 005930.KS、000660.KS、7203.T、BMW.DE
   - 如新闻涉及非支持市场公司，只能在主题或风险提示中提及，不要写入 stock_leads

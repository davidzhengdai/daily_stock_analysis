...
def default_hypotheses_path() -> Path:
    ...
    Returns:
        Env override path when ``DSA_HYPOTHESES_PATH`` is set,
        otherwise ``~/.daily-stock-analysis/hypotheses.json``.
    """
    override = os.environ.get(_ENV_PATH, "").strip()
    if override:
        return Path(override).expanduser()
    return Path.home() / ".daily-stock-analysis" / "hypotheses.json"
...
class Hypothesis:
    ...
    Attributes:
        ...
        skills: Relevant analysis skills.
    ...
    def __init__(self, path: Path | None = None) -> None:
        ...
        Args:
            path: Optional storage path. Defaults to env override or
                ``~/.daily-stock-analysis/hypotheses.json``.
        """
    ...
    def create(
        ...
        *,
        ...
        Args:
            ...
            skills: Related analysis skills.
...
# Singleton instance
_registry_instance: HypothesisRegistry | None = None

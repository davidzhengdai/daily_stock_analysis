...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        "category": "sentinel",
        "title": "News Sentinel",
        "description": "Active news scraping service: spiders, scheduling, and LLM classification settings.",
        "display_order": 58,
    },
    {
        "category": "discovery",
        "title": "Discovery",
        "description": "NewsHeatRadar, DiscoveryList, post-close scan, and discovery AutoTrade controls.",
        "display_order": 59,
    },
    {
        "category": "backtest",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REALTIME_SOURCE_PRIORITY": {
        ...
        "description": "Comma-separated priority for realtime quote providers, e.g. moomoo,tencent,akshare_sina,efinance,akshare_em.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "MOOMOO_OPEND_HOST": {
        "title": "Moomoo OpenD Host",
        "description": "Host for the local Moomoo OpenD gateway used when REALTIME_SOURCE_PRIORITY includes moomoo.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "MOOMOO_OPEND_PORT": {
        "title": "Moomoo OpenD Port",
        "description": "Port for the local Moomoo OpenD gateway used when REALTIME_SOURCE_PRIORITY includes moomoo.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOOMOO_OPEND_CONNECT_TIMEOUT": {
        "title": "Moomoo OpenD Connect Timeout",
        "description": "Socket precheck timeout in seconds before creating the Moomoo OpenD quote context.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOOMOO_EXTENDED_TIME": {
        "title": "Moomoo Extended Hours",
        "description": "Request US pre-market and after-hours quotes from Moomoo when available.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "REPORT_INTEGRITY_RETRY_MAX_TOKENS": {
        "title": "Report Integrity Retry Max Tokens",
        "description": "Maximum output tokens for mandatory-field completion retries. Lower values reduce local LLM retry latency.",
        "category": "notification",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_ENABLED": {
        "title": "Sentinel Enabled",
        "description": "Enable the News Sentinel active scraping service.",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SENTINEL_LLM_MODEL": {
        "title": "Sentinel LLM Model",
        "description": "Model used by the Sentinel news classifier. Empty inherits LITELLM_MODEL.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_SERVER_URL": {
        "title": "Sentinel Server URL",
        "description": "HTTP base URL used by the stock server to access the Sentinel service.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_CYCLE_INTERVAL_MINUTES": {
        "title": "Scrape Cycle Interval (min)",
        "description": "How often the sentinel fetches new articles from all spider sources, in minutes.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_ANALYSIS_INTERVAL_HOURS": {
        "title": "Analysis Interval (hours)",
        "description": "How often the sentinel runs LLM-based cycle analysis.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_MAX_CACHE_AGE_HOURS": {
        "title": "Max Cache Age (hours)",
        "description": "Maximum cache age before falling back to online search.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_LLM_BATCH_SIZE": {
        "title": "LLM Batch Size",
        "description": "Number of news items sent to the LLM classifier in a single API call.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_ENABLED_SPIDERS": {
        "title": "Enabled Spiders",
        "description": "Comma-separated spider names to run, or all.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_TRADING_HOURS_BOOST": {
        "title": "Trading Hours Boost",
        "description": "Boost article priority during A-share trading hours.",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SENTINEL_WATCHED_STOCKS_BOOST": {
        "title": "Watched Stocks Boost",
        "description": "Boost articles that mention watched stocks during classification.",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "SENTINEL_ENABLED": {
        "title": "Sentinel Enabled",
        "description": "Enable the News Sentinel active scraping service. Requires the sentinel Docker container (or the sentinel --loop process) to be running.",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SENTINEL_LLM_MODEL": {
        "title": "Sentinel LLM Model",
        "description": "Model used by the Sentinel news classifier. Accepts any LiteLLM model name (e.g. gemini/gemini-2.0-flash). When empty, inherits the global LITELLM_MODEL.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_SERVER_URL": {
        "title": "Sentinel Server URL",
        "description": "HTTP base URL used by the stock server to access the Sentinel service. In Docker Compose this is http://sentinel:9100. Leave empty to read the local SQLite cache directly.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_ANALYSIS_INTERVAL_HOURS": {
        "title": "Analysis Interval (hours)",
        "description": "How often the sentinel runs LLM-based cycle analysis to produce market themes and stock leads.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_MAX_CACHE_AGE_HOURS": {
        "title": "Max Cache Age (hours)",
        "description": "If no successful spider run has been recorded within this window, the cache is treated as stale and the stock server falls back to online search.",
        "category": "sentinel",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SENTINEL_ENABLED_SPIDERS": {
        "title": "Enabled Spiders",
        "description": "Comma-separated list of spider names to run, or 'all' to enable every built-in spider.",
        "category": "sentinel",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SENTINEL_TRADING_HOURS_BOOST": {
        "title": "Trading Hours Boost",
        "description": "Give newly-scraped articles a +1 priority bonus during A-share trading hours (09:30–15:00 CST).",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SENTINEL_WATCHED_STOCKS_BOOST": {
        "title": "Watched Stocks Boost",
        "description": "Give articles that mention a watched stock a +1 priority bonus during classification.",
        "category": "sentinel",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    # ------------------------------------------------------------------
    # Discovery / NewsHeatRadar
    # ------------------------------------------------------------------
    "HEAT_RADAR_ENABLED": {
        "title": "Heat Radar Enabled",
        "description": "Enable NewsHeatRadar manual/API scans and post-close HeatRadar execution.",
        "category": "discovery",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "POST_CLOSE_SCAN_ENABLED": {
        "title": "Post-Close Scan Enabled",
        "description": "In schedule mode, automatically trigger Scanner, GoldDigger, and NewsHeatRadar after CN/US market close.",
        "category": "discovery",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DISCOVERY_AUTO_TRADE_ENABLED": {
        "title": "Discovery AutoTrade Enabled",
        "description": "Allow AutoTrade to process active DiscoveryList stocks in addition to the watchlist.",
        "category": "discovery",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DISCOVERY_DYNAMIC_EXIT_LEVELS_ENABLED": {
        "title": "Dynamic Exit Levels",
        "description": "Use AI/technical stop-loss and take-profit price levels for discovery AutoTrade orders when valid; otherwise fall back to fixed percentages.",
        "category": "discovery",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "HEAT_RADAR_MARKETS": {
        "title": "Heat Radar Markets",
        "description": "Markets scanned by NewsHeatRadar. Comma-separated values: us,cn.",
        "category": "discovery",
        "data_type": "array",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "POST_CLOSE_SCAN_MARKETS": {
        "title": "Post-Close Scan Markets",
        "description": "Markets watched by the post-close trigger. Comma-separated values: us,cn.",
        "category": "discovery",
        "data_type": "array",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "HEAT_RADAR_TOP_N": {
        "title": "Heat Radar Top N",
        "description": "Maximum number of hot picks returned by each NewsHeatRadar run.",
        "category": "discovery",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVERY_AUTO_TRADE_POSITION_PCT": {
        "title": "Discovery Position %",
        "description": "Available cash percentage used for discovery-driven buy orders.",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVERY_AUTO_TRADE_STOP_LOSS_PCT": {
        "title": "Discovery Stop Loss %",
        "description": "Stop-loss percentage below entry for discovery-driven positions.",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVERY_AUTO_TRADE_TAKE_PROFIT_PCT": {
        "title": "Discovery Take Profit %",
        "description": "Take-profit percentage above entry for discovery-driven positions.",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVERY_MIN_SIGNAL_CONFIDENCE": {
        "title": "Discovery Min Signal Confidence",
        "description": "Minimum AI signal confidence for discovery short-term picks.",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,

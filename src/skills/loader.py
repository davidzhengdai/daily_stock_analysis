...
USER_SKILLS_DIR = Path.home() / ".daily-stock-analysis" / "skills" / "user"
...
class SkillsLoader:
    ...
    def __init__(self, skills_dir: Optional[Path] = None,
        ...
        Args:
            skills_dir: Bundled skills directory path; defaults to src/skills/.
            user_skills_dir: User-created skills directory; defaults to ~/.daily-stock-analysis/skills/user/.
        """
        self.skills_dir = skills_dir or Path(__file__).resolve().parents[1] / "skills_library"
    ...
    def list_skills(self) -> List[Dict[str, Any]]:
        """Return list of skills with metadata."""
        return [
            {
                "name": s.name,
...
def get_skills_loader() -> SkillsLoader:
    """Get the singleton skills loader instance."""
